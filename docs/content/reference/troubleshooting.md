...
Most of these come down to network reality or how kattis serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kattis rate-limits like any public site. kattis already paces
...
Where a surface is gated, kattis reads a cookie or token you supply
...
`kattis`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kattis actually did
